...
def max_entropy(model, images, args):
...
def cli_main():
    ...
    for batch_index in range(100):
        ...
        # ========================= implement max_entropy approach =========================
        new_indices = max_entropy(model, full_images[unqueried_indices], args)
        # =================================================================================================
        ...
        with open('./max_entropy_10_lr_0.001_bs_10_500_epoch_2pm_dropout_niter50.json', 'w') as f:
