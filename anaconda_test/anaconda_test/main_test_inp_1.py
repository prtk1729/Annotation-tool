...
app.layout = html.Div([
    html.Button("Load", id="load",
                style={'backgroundColor': "green", "color": "#ffffff", "margin": "20px", "padding": "10px"}),
    html.Button("Next", id="next",
                style={'backgroundColor': "blue", "color": "white", "margin": "20px", "padding": "10px"}),
    html.Button("Save", id="save",
                style={'backgroundColor': "SlateBlue", "color": "white", "margin": "20px", "padding": "10px"}),
    html.Button("Export", id="export",
                style={'backgroundColor': "Tomato", "color": "white", "margin": "20px", "padding": "10px"}),
