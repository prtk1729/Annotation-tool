...
def card_body(card_id):
    ...
    return [
        dbc.CardImg(src=paths_of_images[card_id], top=True, style={"height": "120px", "width": "165px"}),
        dbc.CardBody([
            dcc.RadioItems(
                id={
                    'type': 'label-option',
...
app.layout = html.Div([
    html.Button("Start", id="start",
                style={'backgroundColor': "black", "color": "#ffffff", "margin": "5px", "padding": "px"}),
    html.Button("Load", id="load",
                style={'backgroundColor': "green", "color": "#ffffff", "margin": "5px", "padding": "1px"}),
    html.Button("Next", id="next",
                style={'backgroundColor': "blue", "color": "white", "margin": "5px", "padding": "1px"}),
    html.Button("Save", n_clicks=0, id="save",
                style={'backgroundColor': "SlateBlue", "color": "white", "margin": "5px", "padding": "1px"}),
    html.Button("Export", value='Export', n_clicks=0, id="export",
                style={'backgroundColor': "Tomato", "color": "white", "margin": "5px", "padding": "1px"}),
    html.Div(id="card-deck"),
    html.H3(id='button-clicks'),

], style={'text-align': "center", "margin": "0.05em 0em"})
...
def gen_cards(current_24):
    ...
    return [
        dbc.Row([
            dbc.Col([card(i)]) for i in current_24[:8]]),
        dbc.Row([
            dbc.Col([card(i)]) for i in current_24[8:16]]),
        dbc.Row([
            dbc.Col([card(i)]) for i in current_24[16:24]]),
    ]
